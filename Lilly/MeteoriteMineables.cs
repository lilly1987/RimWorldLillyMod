        ...
        public static void SetValue(int min=25,int max=100)
        {
            ...
            try
            {
                ...
                if (field != null)
                {
                    ...
                    MyLog.Warning($"{HarmonyId} MineablesCountRange has been overridden to {range.min}~{range.max}");
                }
                else
                {
                    MyLog.Warning($"{HarmonyId} Failed to find MineablesCountRange field");
                }
